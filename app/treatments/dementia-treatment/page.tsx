...
export default function DementiaTreatmentPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-slate-800 mb-6 leading-tight">
            Dementia Treatment in Jaipur
          </h2>

          {/* Text */}
          <p className="text-slate-500 leading-relaxed mb-6">
            <span className="text-teal-600 font-semibold">
              Dementia is a neurological condition
            </span>{" "}
            in which a person loses the ability to think, remember, and perform
            daily activities due to damage in brain cells.
          </p>

          {/* Highlight Box */}
          <div className="bg-teal-50 border-l-4 border-teal-600 p-4 rounded-md mb-6">
            <p className="text-slate-500 text-sm">
              With early diagnosis and proper treatment, patients can manage
