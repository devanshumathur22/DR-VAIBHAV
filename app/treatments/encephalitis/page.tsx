...
export default function EncephalitisPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-slate-800 mb-6 leading-tight">
            Encephalitis Treatment in Jaipur
          </h2>
          ...
          <p className="text-slate-500 leading-relaxed mb-6">
            ...
            usually caused by viral infections. It can affect brain function and
            may lead to serious complications if not treated on time.
          </p>

          {/* Highlight Box */}
          <div className="bg-teal-50 border-l-4 border-teal-600 p-4 rounded-md mb-6">
            <p className="text-slate-500 text-sm">
              Early diagnosis and immediate medical care are essential to prevent
          ...
          {/* Extra Text */}
          <p className="text-slate-500 leading-relaxed mb-6">
            Symptoms may include fever, headache, confusion, seizures, and
            difficulty in movement or speech. At Brainspinemind, we provide
            advanced neurological care for effective management and recovery.
          </p>
