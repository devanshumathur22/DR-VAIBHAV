...
export default function DystoniaPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-slate-800 mb-6 leading-tight">
            Dystonia & Spasms Treatment in Jaipur
          </h2>
          ...
          <p className="text-slate-500 leading-relaxed mb-6">
            ...
            caused by abnormal brain signals that lead to involuntary muscle
            contractions. These contractions result in repetitive movements or
            abnormal postures.
          </p>
          ...
          <div className="bg-teal-50 border-l-4 border-teal-600 p-4 rounded-md mb-6">
            <p className="text-slate-500 text-sm">
              Treatment options include medications, physiotherapy, and{" "}
              <span className="text-teal-600 font-semibold">
                Botulinum toxin injections
              </span>{" "}
              which are highly effective in controlling symptoms.
            </p>
          </div>
          ...
          <ul className="space-y-3 text-slate-500">
            {[
              ...
              "Abnormal postures",
              "Twisting movements",
              "Neck bending (cervical dystonia)",
